...
export default function RegionFilter({ selectedRegion, onSelectRegion }: RegionFilterProps) {
  return (
    <div className="w-full bg-white/95 backdrop-blur-md border-b border-slate-200/80 px-3 py-2 z-10 shadow-2xs">
        ...
        {REGIONS.map((region) => {
          ...
          return (
            <button
              ...
              className={clsx(
                'px-3.5 py-1.5 rounded-full text-xs font-semibold whitespace-nowrap transition-all duration-150 shrink-0 border',
                isSelected
