...
import { Users, Car, MapPin, Calendar, Hourglass, AlertCircle, Navigation } from 'lucide-react';
        ...
        {festivals.map((fest) => {
          ...
          return (
            <div
              ...
              className={clsx(
                'snap-center shrink-0 w-[300px] p-3.5 bg-white/95 backdrop-blur-md rounded-2xl border transition-all duration-200 shadow-md cursor-pointer flex flex-col justify-between',
                isSelected
